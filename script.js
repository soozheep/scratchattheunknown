const SITE_URL = 'https://scratchattheunknown.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Scratch At the Unknown — Sonic Remedy | Soozhee',
        text: 'Embrace the unknown, let it guide your steps. Scratch At the Unknown by Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
